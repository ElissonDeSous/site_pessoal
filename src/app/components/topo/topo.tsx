...
export default function Topo(){
    ...
    return(
     <header className="h-[70px] fixed w-full flex  bg-black text-white items-center justify-around ">
            <div>
                <Link href="/">
                   <Image className='md:w-[70px] w-[100px]' src = {Logo} width={100} alt='Logo da empresa' />
                </Link>
            ...
            <nav>
                ...
                <div onClick={menu} className='md:hidden flex border-solid border-1 border-red-500 '>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="80" height="128" viewBox="0 0 128 128">
                ...
                <div id='OpenMenu' className='flex   flex-col md:hidden hidden  border-solid border-red-500 border-2 absolute top-[70px]  bg-black w-full  h-[500px]   justify-around items-center'>
                        <Link className='font-bold hover:text-red-500 ' href='/'>Página inicial</Link>
                        <Link className='font-bold hover:text-red-500' href='/servico'>Serviços</Link>
                        <Link className='font-bold hover:text-red-500' href='/servico'>Quem Somos</Link>
                        <Link className='font-bold hover:text-red-500' href='/servico'>Contato</Link>
